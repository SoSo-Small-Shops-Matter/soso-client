  ...
  if (isLoading) {
    return (
      <div className="flex items-center justify-center py-60">
        <p className="text-gray-400 font-body1_m">검색 중...</p>
      </div>
    )
  }
  ...
  if (results.length === 0) {
    return (
      <div className="flex flex-col items-center justify-center gap-16 py-80">
        <p className="text-gray-800 font-body1_m">검색하신 소품샵이 없습니다.</p>
        <p className="text-gray-400 font-caption">소품샵을 등록해보세요!</p>
        <Link href="/shop/register" className="rounded-full border border-main px-20 py-10 text-main font-body2_m">
          소품샵 등록하기
        </Link>
      </div>
    )
