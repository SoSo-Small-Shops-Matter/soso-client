...
export default function MapIcon({ width = '16', height = '16', color = 'var(--gray-500)' }: IconProps) {
  return (
    <svg width={width} height={height} viewBox={`0 0 ${width} ${width}`} fill="none" xmlns="http://www.w3.org/2000/svg">
      <g clipPath="url(#clip0_2341_12170)" transform={`translate(${(+width - 20) / 2}, ${(+width - 19.53) / 2})`}>
        ...
        />
        <path d="M13 3.52979V18.5298" stroke={color} strokeWidth="1.3" strokeLinecap="round" strokeLinejoin="round" />
        <path d="M7 1V16" stroke={color} strokeWidth="1.3" strokeLinecap="round" strokeLinejoin="round" />
      </g>
      <defs>
